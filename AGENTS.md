...
This project is indexed by GitNexus as **GodotEngineForCommandPalette** (277 symbols, 638 relationships, 21 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/GodotEngineForCommandPalette/context` | Codebase overview, check index freshness |
| `gitnexus://repo/GodotEngineForCommandPalette/clusters` | All functional areas |
| `gitnexus://repo/GodotEngineForCommandPalette/processes` | All execution flows |
| `gitnexus://repo/GodotEngineForCommandPalette/process/{name}` | Step-by-step execution trace |
