...
This project is indexed by GitNexus as **GodotEngineForCommandPalette** (238 symbols, 517 relationships, 19 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
